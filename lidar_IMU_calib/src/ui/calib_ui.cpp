...
CalibInterface::CalibInterface(ros::NodeHandle& nh) :
        CalibrHelper(nh),
        A_string("ui.calibration_tool","lidar-imu_calib"),
        ...
        optimize_time_offset_("ui.optimize_time_offset", true, false, true),
...
void CalibInterface::initGui() {
  pangolin::CreateWindowAndBind("LiDAR-IMU Calibration Tool", 1600, 1000);
